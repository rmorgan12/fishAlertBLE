...
export const PulseIndicator = () => {
  ...
  const expo = useImage(require("/Users/rileymorgan/expo-ble-sample2/assets/faLogo.jpg"));
  const heart = useImage(require("/Users/rileymorgan/expo-ble-sample2/assets/faLogo.jpg"));
